...
- (void)initBaseUI
{
    ...
    _titleLabel.font = kFontSize(21);
    _titleLabel.textColor = [UIColor colorWithHexString:@"#333333"];
    _titleLabel.textAlignment = NSTextAlignmentLeft;
    _titleLabel.text = @"嗨泊停车";
    _titleLabel.frame = CGRectMake(16, 27, SCREEN_WIDTH - 80, 30);
    ...
    _inputBtn.frame = CGRectMake(72, orginY+50, 56, 56);
    _inputBtn.layer.cornerRadius = 28.0;
    _inputBtn.clipsToBounds = YES;

    _inputBtn.backgroundColor = [UIColor whiteColor];

    [_inputBtn setImage:[UIImage imageNamed:@"手动输入泊位编号"] forState:UIControlStateNormal];
    ...
    _inputBtnLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, orginY+116, 120, 30)];
    _inputBtnLabel.centerX = _inputBtn.centerX;
    _inputBtnLabel.text = @"手动输入泊位编号";
    _inputBtnLabel.textAlignment = NSTextAlignmentCenter;
    _inputBtnLabel.font = [UIFont systemFontOfSize:13];
    ...
    _torchBtn.frame = CGRectMake(Width - 72 - 56, orginY+56, 56, 56);
    _torchBtn.backgroundColor = [UIColor colorWithHexString:@"#EDBD03"];

    _torchBtn.layer.cornerRadius = 28.0;
    _torchBtn.clipsToBounds = YES;

    [_torchBtn setImage:[UIImage imageNamed:@"手电筒"] forState:UIControlStateNormal];
    ...
    _tipLabel = [[UILabel alloc] initWithFrame:CGRectMake(Width- 120, orginY+116, 100, 30)];
    _tipLabel.centerX = _torchBtn.centerX;
    _tipLabel.text = @"手电筒";
...
#pragma mark - 扫描结果超时
-(void)presentToOverTimeVc
{
    HPHomePageScanOverTimeViewController * overTime = [HPHomePageScanOverTimeViewController new];
    overTime.view.backgroundColor=[UIColor colorWithWhite:0 alpha:0.4];
    //关键语句，必须有
    overTime.modalPresentationStyle = UIModalPresentationOverFullScreen;
    [self presentViewController:overTime animated:NO completion:^{
        overTime.view.superview.backgroundColor = [UIColor clearColor];
    }];
