...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _rightBtnTitle = @"确定";
        _rightBtnBGColor =  [UIColor whiteColor];//CGXPickerRGBColor(252, 96, 134, 1);
        _rightBtnTitleSize = 16;
        _rightBtnTitleColor = [UIColor blackColor];
        
        _rightBtnborderColor = [UIColor whiteColor];//CGXPickerRGBColor(252, 96, 134, 1);
        _rightBtnCornerRadius = 6;
        _rightBtnBorderWidth = 1;
        
        _leftBtnTitle = @"取消";
        _leftBtnBGColor =  [UIColor whiteColor];//CGXPickerRGBColor(252, 96, 134, 1);
        _leftBtnTitleSize = 16;
        _leftBtnTitleColor = [UIColor blackColor];
        
        _leftBtnborderColor = [UIColor whiteColor];//CGXPickerRGBColor(252, 96, 134, 1);
